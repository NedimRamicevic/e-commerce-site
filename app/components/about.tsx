...
function about() {
  return (
    <section id="about">
  <div className="my-12 pb-12 md:pt-16 md:pb-48 bg-white">
    ...
    >
      <div className="md:w-1/2">
        ...
        <p>
          ...
          <span className="font-bold">h ighly ambitious</span>,
          <span className="font-bold">self-motivated</span>, and
          <span className="font-bold">driven</span> software engineer based in
          Istanbul.
        </p>
        <br />
        <p>

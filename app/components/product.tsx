...
console.log(params.product)
  ...
  return(
	...
	<div className="bg-gray-100 text-black shadow-md rounded-lg max-w-sm ">
		<a href="#">
			<Image className="rounded-t-lg p-8" width={300} height={300} src={params.product.image} alt="product image"/>
        </a>
			<div className="px-5 pb-5">
				<a href="#">
					<h3 className="text-black font-semibold text-xl tracking-tight ">{params.product.description}</h3>
				</a>

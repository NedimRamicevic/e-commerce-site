  ...
  <div className="flex shadow-md my-10">
    <div className="w-3/4 bg-white px-10 py-10">
      ...
      <div className="flex mt-10 mb-5">
        ...
        <h3
          className="font-semibold - text-gray-600 text-xs uppercase w-1/5 text-center"
        >
          Quantity
        </h3>
        <h3
      ...
      </div>
     {
        products.map((product: any) => (
            <div key={product.id}
            className="flex items-center text-black hover:bg-gray-100 -mx-8 px-6 py-5">
           <div className="flex w-2/5">
             <div className="w-20">
               <Image className="h-24" src={product.image} width={300} height={300} alt="" />
             </div>
